...
class CastlebridgeHomesSpider(scrapy.Spider):
    name = 'castlebridge_homes'
    allowed_domains = ['https://castlebridgehomesomaha.com/']
    start_urls = ['https://castlebridgehomesomaha.com/communities/']
