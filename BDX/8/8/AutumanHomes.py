...
class autumnhomeSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        plan='https://www.autumnhomesinc.com/'
        yield scrapy.Request(url=plan, callback=self.plan, dont_filter=True)
    ...
    def plan(self,response):
        ...
        yield scrapy.Request(url=home_link, callback=self.home_data, dont_filter=True,meta={'PN':unique_number})
