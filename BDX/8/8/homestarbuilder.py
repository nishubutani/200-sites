...
class HomestarbuilderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        item[
            'SubDescription'] = 'We work directly with our manufacturers to provide the best quality and the best price in the market. Even the best of the best products can fail without proper installation so we have our own experienced, trained technicians to install all our products'
        item[
            'SubImage'] = 'https://homestarbuilder.com/wp-content/themes/elegance/lib/scripts/timthumb/thumb.php?src=https://homestarbuilder.com/wp-content/uploads/2015/10/Captiva_Model.png&w=560&h=400&zc=1&q=100'
