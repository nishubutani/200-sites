...
class eglecreckSpider(scrapy.Spider):
    ...
    def page(self,response):
        ...
        links = response.xpath('//h2/..//a[@class="c-button"]/@href').extract()
        for k in links:
            comn= k
