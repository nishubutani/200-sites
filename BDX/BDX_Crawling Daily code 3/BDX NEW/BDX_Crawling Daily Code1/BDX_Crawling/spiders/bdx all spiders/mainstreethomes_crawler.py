...
if __name__ == '__main__':
    ...
    execute('scrapy crawl mainstreethomes_crawler'.split())


# from scrapy.cmdline import execute
# execute("scrapy crawl mainstreethomes_crawler --nolog".split())